...
import ProgrammManagment.CommandInsert;
    ...
    public List<Movie> parseMovies() throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            try {
                ...
                MovieGenre genre = MovieGenre.valueOf(data[6]);
                MpaaRating mpaaRating = MpaaRating.valueOf(data[7]);
                
                String operatorName = data[8];
                LocalDateTime operatorBirthday = LocalDateTime.parse(data[9]);
